...
- Last Study Session
    ...
    shows when the previous activity was used
    summarizes wrong vs correct of the prior activity
...
#### Purpose
This page aims to show the details of a study activity and its past study sessions.
...
- Name of study activity
- Launch form
    - select the field for the group
    - launch now button

## Behaviour
After the form is submitted, a new tab opens with the study activity, which is based on its URL provided in the database.

Also, once the form is submitted, the page will redirect to the study sesssion and show the page.
...
#### Purpose
This page aims to show information about a specific study session.
