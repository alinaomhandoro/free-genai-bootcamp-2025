...
- Everything is treated as a single-user
...
Please note that the front end will determine the progress bar based on the total and available words studied.
...
Let's list possible tasks we need for our language portal.
