...
- Last Study Session
    ...
    summarizes wrong vs correct from the previous activity
...
- Study Progress
    ...
    - display mastery progress, e.g. 0%
- Quick Stats
    - success rate eg. 80%
...
Also, once the form is submitted, the page will redirect to the study session show page.
